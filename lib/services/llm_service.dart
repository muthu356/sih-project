...
class LLMService {
  ...
  static const String _apiKey = 'AIzaSyDnqapdvOuyhuy147IG1_Rr0iMQhG3UhJE';
...
- Use Markdown for formatting (bold, lists, code blocks) to make your responses easy to read.
'''),
        ]),
        Content('model', [
